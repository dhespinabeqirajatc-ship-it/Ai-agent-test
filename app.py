...
def build_pdf_export(quarter, source, summary, management_summary, data, plan, export_state=None):
    ...
    story += [
        ...
        Spacer(1, 10),
        _pdf_paragraph(
            "Contents: Executive view; Overview dashboard; Financials; Trends and drivers; Forecasting/scenarios/backtesting; Quarter comparison and variance bridge; Data quality; Decision signals/watchlist; AI interaction appendix; Source provenance.",
            styles["BodyText"],
        ),
        PageBreak(),
    ]
    ...
    # Provenance
    story += [PageBreak(), Paragraph("11. Source and provenance", styles["Heading1"])]
